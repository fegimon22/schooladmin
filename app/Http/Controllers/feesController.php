...
class feesController extends Controller {
	...
	public function getsetup()
	{
		...
		return view('fee.feesSetup', compact('classes'));
	}
	...
	*/
	...
	public function getList()
	{
		...
		$formdata->class="";
		return view('fee.feeList', compact('classes','formdata','fees'));
	}
	/**
	...
	*/
	public function getEdit($id)
	{
		...
		return view('fee.feeEdit', compact('fee','classes'));
	...
	*/
	...
	{
		$classes = ClassModel::select('code','name')->orderby('code','asc')->get();
		return view('fee.feeCollection', compact('classes'));
	}
	...
	public function stdfeeview()
	{
		...
		$student->regiNo="";
		$fees=array();
		return view('fee.feeviewstd', compact('classes','student','fees'));
	}
	public function stdfeeviewpost()
	{
		...
		return view('fee.feeviewstd', compact('classes','student','fees','totals'));
	}
	...
	public function reportstd($regiNo)
	{
		...
		$pdf = PDF::loadView('fee.feestdreportprint',compact('datas','rdata','stdinfo','institute'));
		return $pdf->stream('student-Payments.pdf');

	}
	public function report()
	{
		return view('fee.feesreport');
	}
	public function reportprint($sDate,$eDate)
	{
		...
		$pdf = PDF::loadView('fee.feesreportprint',compact('datas','rdata','institute'));
