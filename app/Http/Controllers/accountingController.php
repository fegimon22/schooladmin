...
class accountingController extends Controller {
	...
	*/
	public function sectors()
	{
		...
		$sector = array();
		return view('accounting.accountsector', compact('sectors','sector'));
	}
	...
	*/
	...
	public function  income()
	{
		...
		return view('accounting.accountIncome', compact('sectors'));
	...
	{
		$incomes = array();
		return view('accounting.accountIncomeView', compact('incomes'));
	}
	...
	public function  incomeEdit($id)
	{
		...
		return view('accounting.accountIncomeEdit', compact('income'));
	}
	...
	public function  expence()
	{
		...
		return view('accounting.accountExpence', compact('sectors'));
	...
	{
		$expences = array();
		return view('accounting.accountExpenceView', compact('expences'));
	}
	...
	public function  expenceEdit($id)
	{
		...
		return view('accounting.accountExpenceEdit', compact('expence'));
	}
