...
class attendanceController extends Controller {
    ...
    public function index()
    {
        ...
        $attendance=array();
		return view('attendance.attendanceCreate', compact('classes2','classes','subjects','attendance'));
    }

    public function index_file()
    {
		return view('attendance.attendanceCreateFile');
    }
    ...
    public function show()
    {
        ...
        //$formdata["class"]="";
		return view('attendance.attendanceList', compact('classes','attendance','formdata'));
    }
    ...
    public function getlist()
    {
        ...
        if ($validator->fails())
        {
			...
			return view('attendance.attendanceList', compact('classes2','attendance','formdata'));
        }
    }
    /**
