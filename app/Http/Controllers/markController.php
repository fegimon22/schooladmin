...
class markController extends Controller {
    ...
    public function index()
    {
		...
		return view('mark.markCreate', compact('classes','subjects'));
    }
    ...
    public function show()
    {
        ...
        //$formdata["class"]="";
		return view('mark.markList', compact('classes','marks','formdata'));
    }
    ...
    public function getlist()
    {
        ...
        if ($validator->fails())
        {
			...
			return view('mark.markList', compact('classes2','subjects','marks','formdata'));
        }
    }
    ...
    public function edit($id)
    {
		...
		return view('mark.markEdit', compact('marks'));
