...
class subjectController extends Controller {
	...
	*/
	public function index()
	{
		...
		$gpa =GPA::select('for')->distinct()->get();
			return view('subject.subjectCreate', compact('classes','gpa'));
	}
	...
	*/
	public function show()
	{
		...
		return view('subject.subjectList', compact('Subjects'));
	}
	...
	*/
	public function edit($id)
	{
		...
		return view('subject.subjectEdit', compact('subject','classes'));
	}
