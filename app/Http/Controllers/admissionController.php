...
class admissionController extends Controller {
	...
	*/
	public function regonline()
	{
		...
		return view('admission.admissionForm', compact('classes'));
	}
...
public function applicants()
{
	...
	$formdata->session = "";
	$students=array();
	return view('admission.applicantList', compact('classes','formdata','students'));
...
public function applicantview($id)
{
	...
	return view('admission.applicant', compact('student'));
}
...
public function admitcard()
{
	...
	return view('admission.admitcard');
}
public function printAdmitCard()
{
	...
	if ($validator->fails())
	{
		...
		if(count($data)>0)
		{
			...
			$pdf = PDF::loadView('admission.printAdmitCard',compact('data','institute'));
